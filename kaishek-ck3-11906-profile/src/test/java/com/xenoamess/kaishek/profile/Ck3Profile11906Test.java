...
class Ck3Profile11906Test {
    ...
    void genericProjectionAndSchemaShareTheSameOpcodeIds() {
        ...
        assertTrue(profile.opcode("can_be_acclaimed") != null);
        ...
        assertTrue(profile.opcode("has_cultural_parameter") != null);
    ...
    @Test
    void canBeAcclaimedIsPinnedAsCharacterBooleanTriggerShape() {
        OpcodeDescriptor descriptor = profile.opcodeRegistry().require("can_be_acclaimed");
        assertEquals(OpcodeKind.TRIGGER, descriptor.kind());
        assertEquals(InputType.BOOLEAN, descriptor.inputType());
        assertEquals(ScopeType.CHARACTER, descriptor.requiredScope());
        assertTrue(descriptor.parameterNames().isEmpty());
    ...
    @Test
    void hasInnovationIsPinnedAsScalarCultureMembershipTriggerShape() {
        OpcodeDescriptor descriptor = profile.opcodeRegistry().require("has_innovation");
        assertEquals(OpcodeKind.TRIGGER, descriptor.kind());
        assertEquals(InputType.STRING, descriptor.inputType());
    ...
    @Test
    void hasCulturalParameterIsPinnedAsScalarCultureParameterTriggerShape() {
        OpcodeDescriptor descriptor = profile.opcodeRegistry().require("has_cultural_parameter");
        assertEquals(OpcodeKind.TRIGGER, descriptor.kind());
        assertEquals(InputType.STRING, descriptor.inputType());
        assertEquals(ScopeType.CULTURE, descriptor.requiredScope());
        assertTrue(descriptor.parameterNames().isEmpty());
