...
public final class KaishekCli {
  ...
  private static int validate(String[] a, PrintStream out) throws IOException {
    ...
    boolean known = profile.equals("ck3-1.19.0.6") || profile.equals("ck3-1.19.0.6-zg361")
        ...
        || profile.equals(Eu5Profile1311.ID);
    ...
    KaishekProfile staticProfile = switch (profile) {
      ...
      case StellarisProfile451.ID -> new StellarisProfile451();
  ...
  private static int profile(String[] a, PrintStream out) {
    ...
    if (id.equals(StellarisProfile451.ID)) {
      out.println("{\"status\":\"OK\",\"id\":"+q(id)+",\"game\":\"Stellaris\",\"build\":\"4.5.1\",\"exeSha256\":"+q(StellarisProfile451.EXE_SHA256)+",\"semantic\":\"static\",\"runtime\":\"UNSUPPORTED\"}");
      return 0;
    }
