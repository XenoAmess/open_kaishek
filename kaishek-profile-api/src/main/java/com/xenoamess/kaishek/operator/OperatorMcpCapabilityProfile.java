...
public final class OperatorMcpCapabilityProfile {
    ...
    public static final String LEGACY_CONTRACT_VERSION = "1.0.0";
    ...
    public static final String ROOT_IMPLEMENTATION_SHA256 =
            "E604EF3980A789B71D622581E73C32A15E1F90BA8123C5DCEAC0AAA89FAF8CC5";
    ...
    public static final String ROOT_PROFILE_EXAMPLE_SHA256 =
            "E5C051544A6DDE92B249BC1972E8A8AA278654A63C6C20B99C65C532684B6678";
    public static final String ROOT_CONTRACT_TEST_SHA256 =
            "538331C9261730F555DF76083BD46B0C32493186DEC2FAC97573D973932BC149";
    ...
    public static final String CONTROL_JOB_TOOL = "operator_control_job";
    public static final List<String> LEGACY_TOOLS = List.of(
    ...
    public static final List<String> CONTROL_JOB_REQUEST_FIELDS =
            List.of("target_id", "job_name", "job_id", "control_name", "request_id");

    public static final CapabilityDescriptor GET_CAPABILITIES =
            new CapabilityDescriptor(
                    GET_CAPABILITIES_TOOL,
                    "operator-mcp-capabilities-1.1.0",
                    List.of(
                            "schema_version", "server_version", "server_instance_id",
                            "target_id", "display_name", "profile_sha256", "endpoint",
                            "jobs", "job_controls", "tools", "caller_supplied_commands",
                            "operator_bootstrap_required"),
                    List.of(
                            "read_only_tool",
                            "target_endpoint_identity_and_jobs_come_from_profile",
                            "job_controls_disclose_names_but_never_payloads",
                            "profile_schema_1_without_controls_remains_compatible",
    ...
    public static final CapabilityDescriptor GET_STATUS =
            new CapabilityDescriptor(
                    ...
                    List.of(
                            ...
                            "job_status_discloses_available_control_names_not_payloads",
    ...
    public static final CapabilityDescriptor PREFLIGHT_JOB =
            new CapabilityDescriptor(
                    PREFLIGHT_JOB_TOOL,
                    "operator-mcp-preflight-job-1.1.0",
                    List.of(
                    ...
                    List.of(
                            ...
                            "job_spec_sha256_binds_named_controls_and_payload_hashes",
    ...
    public static final CapabilityDescriptor HANDOFF_JOB =
            new CapabilityDescriptor(
                    HANDOFF_JOB_TOOL,
                    "operator-mcp-handoff-job-1.1.0",
                    List.of(
                    ...
                    List.of(
                            ...
                            "job_result_discloses_available_control_names_not_payloads",
                            "handoff_is_non_destructive_but_may_start_an_open_world_process"),
                    false, false, false, false);

    public static final CapabilityDescriptor CONTROL_JOB =
            new CapabilityDescriptor(
                    CONTROL_JOB_TOOL,
                    "operator-mcp-control-job-1.1.0",
                    List.of(
                            "schema_version", "result", "idempotent_replay", "target_id",
                            "profile_sha256", "job_id", "job_name", "control_name",
                            "payload_bytes"),
                    List.of(
                            "caller_selects_only_a_profile_frozen_control_name",
                            "caller_cannot_supply_stdin_payload",
                            "target_job_and_job_id_must_match_a_live_handoff",
                            "request_id_is_portable_and_idempotent_per_server_instance",
                            "red_write_results_are_frozen_and_not_silently_retried"),
                    false, false, false, false);

    public static boolean isSupportedServerVersion(String version) {
        return LEGACY_CONTRACT_VERSION.equals(version) || CONTRACT_VERSION.equals(version);
    }

    public static boolean isCompatibleUpgrade(String expected, String observed) {
        return expected.equals(observed)
                || (LEGACY_CONTRACT_VERSION.equals(expected)
                && CONTRACT_VERSION.equals(observed));
    }
